  ...
  return (
    ...
    >
      ...
      <div style={{ 
        ...
        color: '#ff3b30', fontWeight: 'bold', fontSize: '1.2rem', opacity: 0.2, zIndex: 2 
      }}>-</div>
      <div style={{ 
        position: 'absolute', right: '12px', top: '50%', transform: 'translateY(-50%)', 
        color: '#34c759', fontWeight: 'bold', fontSize: '1.2rem', opacity: 0.2, zIndex: 2 
      }}>+</div>
      ...
      <div style={{ zIndex: 10, marginTop: '14px' }}>
        <input 
          ...
          onChange={(e) => onManualEntry(item.id, e.target.value.replace(/\D/g, ''))}
          style={{
            width: '70px',
            textAlign: 'center',
            fontSize: '1.8rem',
